...
export function CategoryRow({
	...
	return (
		// biome-ignore lint/a11y/useKeyWithClickEvents: drag-and-drop list row; keyboard navigation handled by dnd-kit
		<div
			role="option"
		...
		>
			<div className="flex min-w-0 items-center gap-1">
				...
				{isEditing ? (
					...
					<button
						type="button"
						className="truncate text-sm text-left bg-transparent border-none p-0 cursor-default"
